...
class SliderButtonWidget extends StatefulWidget {
  ...
  const SliderButtonWidget({
    ...
    this.buttonColor = whiteTransparent,
    ...
    this.disable = false,
  }) : assert((buttonSize ?? 40) <= (height));

  @override
  _SliderButtonState createState() => _SliderButtonState();
}

class _SliderButtonState extends State<SliderButtonWidget> {
  late bool flag;
                    ...
                    child: Container(
                      ...
                      child: widget.child ??
                          Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border.all(
                                    width: 2, color: widget.backgroundColor),
                                boxShadow: widget.boxShadow != null
                                    ? [
                                        widget.boxShadow!,
                                      ]
